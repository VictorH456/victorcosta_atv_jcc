...
SIGNAL \orfinal|z~0_combout\ : std_logic;
...
\orfinal|z~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \orfinal|z~0_combout\ = ( \a~input_o\ & ( !\b~input_o\ ) ) # ( !\a~input_o\ & ( \b~input_o\ ) )
